...
PRIVACY POLICY
    ...
    <p>
      This Privacy Policy governs the manner in which WCS Chart collects, uses, maintains and discloses information
      collected from users (each, a
      {' '}
      {'"User"'}
) of the https://
      {webAddress}
...
Personal identification information
    ...
    <p>
      ...
      resources we make available on our Site. We will collect personal identification information from Users only if
      they voluntarily submit such information to us. Users can always refuse to supply personally identification
...
to enhance User experience.
      ...
      {"User's"}
      {' '}
web browser places cookies on their hard
      drive for record-keeping purposes and sometimes to track information about them. User may choose to set their web
...
How we use collected information
    ...
    <p>
WCS Chart may collect and use Users personal information for the following purposes:
    </p>
    <ul>
      <li>
        <i>
...
Third party websites
    ...
    <p>
      ...
      other website, including websites which have a link to our Site, is subject to that
      {' '}
      {"website's"}
      {' '}
own terms and
...
Changes to this privacy policy
    ...
    <p>
      WCS Chart has the discretion to update this privacy policy at any time. When we do, we will post a notification on
      the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about
...
Your acceptance of these terms
    ...
    <p>
      ...
      acceptance of those changes. This privacy policy was built
      {' '}
      <a href="http://privacypolicies.com/" target="_blank" rel="noreferrer noopener">
        the
        {' '}
        {"web's"}
        {' '}
favorite privacy policy generator
      </a>
.
    </p>
