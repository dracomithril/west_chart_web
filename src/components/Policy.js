...
export default () => (
  <div className="policy">
    ...
    <p>WCS Chart may collect and use Users personal information for the following purposes:</p>
    <ul>
      <li>
    ...
    <p>
      ...
      <a href="http://privacypolicies.com/" target="_blank" rel="noreferrer noopener">
        the {"web's"} favorite privacy policy generator
      </a>.
    </p>
