...
export default () => (
  <div className="policy">
    ...
    <p>
      This Privacy Policy governs the manner in which WCS Chart collects, uses, maintains and
      discloses information collected from users (each, a {'"User"'}) of the https://{webAddress}/
      website ({'"Site"'}).
    </p>
    ...
    <p>
      ...
      but not limited to, when Users visit our site, register on the site, and in connection with
      other activities, services, features or resources we make available on our Site. We will
    ...
    <p>
      ...
      about them. User may choose to set their web browser to refuse cookies, or to alert you when
    ...
    <p>
      WCS Chart has the discretion to update this privacy policy at any time. When we do, we will
