...
describe('filters', () => {
  const defaultState = {
    create_control: {
      checked: false, days: 7, id: 'create', type: 'counter',
    },
    less_control: {
      checked: false, days: 15, id: 'less', type: 'counter',
    },
    more_control: {
      checked: false, days: 1, id: 'more', type: 'counter',
    },
    update_control: {
      checked: false, days: 7, id: 'update', type: 'counter',
    },
  ...
  it('should only change selected action control [UPDATE_DAYS]', () => {
    const action = {
  ...
  it('should only change selected action control [TOGGLE_FILTER]', () => {
    const action = {
  ...
  it('should only change selected action control [TOGGLE_FILTER] westletter_cb', () => {
    const action = {
      type: actionTypes.TOGGLE_FILTER,
      id: 'westLetter',
      checked: true,
