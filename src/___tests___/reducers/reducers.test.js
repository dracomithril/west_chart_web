...
const defaultState = reducers(undefined,{id:'something'});
describe('lastUpdateDate', function () {
  ...
  it("should replace current state by new value", function () {
    ...
    const resp = reducers(defaultState, { type: actionTypes.UPDATE_LAST_UPDATE, date: date });
    expect(resp).toHaveProperty('lastUpdateDate', date);
  });
  it('should return current state if type don\'t match', function () {
    const date = "2017-06-16T19:54:25.672Z";
    const resp = reducers(defaultState, { type: actionTypes.TOGGLE_HAS_COOKIE, date: date });
...
describe('show_wait', function () {
  it('should replace current state by new value', function () {
    ...
    const resp = reducers(defaultState, { type: actionTypes.CHANGE_SHOW_WAIT, show: show_wait });
    expect(resp).toHaveProperty('show_wait',false);
  });
  it('should return current state if type don\'t match', function () {
    const date = "zzz";
    const resp = reducers(defaultState, { type: actionTypes.TOGGLE_HAS_COOKIE, show: date });
    expect(resp).toHaveProperty('show_wait',false);
  });
});
describe('startDate', function () {
  ...
  it("should replace current state by new value", function () {
    ...
    const resp = reducers(defaultState, { type: actionTypes.UPDATE_START_TIME, date: date });
...
describe('since', function () {
  it("should replace current state by new value", function () {
    const date = "2017-06-16T19:54:25.672Z";
    const resp = reducers(defaultState, { type: actionTypes.UPDATE_SINCE, value: date });
...
describe('until', function () {
  it("should replace current state by new value", function () {
    const date = "2017-06-16T19:54:25.672Z";
    const resp = reducers(defaultState, { type: actionTypes.UPDATE_UNTIL, value: date });
...
describe('songsPerDay', function () {
  it("should replace current state by new value", function () {
    const resp = reducers(defaultState, { type: actionTypes.UPDATE_SONGS_PER_DAY, days: 3 });
    expect(resp).toHaveProperty('songsPerDay',3);
  });
  it('should return current state if type don\'t match', function () {

    const resp = reducers(defaultState, { type: actionTypes.TOGGLE_HAS_COOKIE, days: 3 });
    expect(resp).toHaveProperty('songsPerDay',3);
  });
  //todo  improve to check if it's date string
});
describe('showLast', function () {
  it("should replace current state by new value", function () {
    const resp = reducers(defaultState, { type: actionTypes.UPDATE_SHOW_LAST, days: 33 });
...
describe('user', function () {
  it("should return current state if response have error", function () {
    ...
    const resp = reducers(defaultState, { type: actionTypes.UPDATE_USER, value: user });
  ...
  it("should return current state if different type used", function () {
    ...
    const resp = reducers(defaultState, { type: actionTypes.UPDATE_SHOW_LAST, value: user });
    expect(resp).toHaveProperty('user',{});
  });
...
describe('spotifyUser', function () {
  it('should be able to update spotifyUser', function () {
    ...
    const result = reducers(defaultState, action);
...
describe('isPlaylistPrivate', function () {
  it("should replace current state by new value", function () {
    ...
    const resp = reducers(defaultState, action);
